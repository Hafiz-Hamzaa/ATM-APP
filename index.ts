...
if (pinAns.pin === myPin) {
  console.log(
    chalk.bold.greenBright("Congratulation!! You have to reached another step")
  );
...
if (operationsAns.operations === "withdraw") {
  ...
  if (amountAns.amount > myBalance) {
    ...
    console.log(
      chalk.bold.magentaBright("Your remaining balance is : " + myBalance)
    );
  }
  ...
  console.log(
    chalk.bold.magentaBright("Your remaining amount is : " + myBalance)
  );
  ...
  console.log(
    chalk.bold.magentaBright(
      "Well Done!! I hope You really enjoy ...Wish you Good Luck..."
    )
  );
}
}
